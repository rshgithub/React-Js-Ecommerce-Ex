...
<Select defaultValue="Name" style={{width:'120px',paddingLeft:"20px"}}>
<Select.Option>Name</Select.Option>
</Select>
</Typography.Text> </Col>
<Col xs={24} xl={6}>
<Typography.Text>Show
<Select defaultValue="12" style={{width:'120px',paddingLeft:"20px"}}>
...
<Button 
size='middle'  
style={{backgroundColor:"rgb(250,250,251)",border:'none',marginRight:'7px'}}
